...
void _bookSerialize(
  ...
  writer.writeLong(offsets[5], object.yearPublished);
}
...
extension BookQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> genreIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> genreIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> yearPublishedEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> yearPublishedGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> yearPublishedLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> yearPublishedBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BookQuerySortBy on QueryBuilder<Book, Book, QSortBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> sortByYearPublished() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'yearPublished', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByYearPublishedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQuerySortThenBy on QueryBuilder<Book, Book, QSortThenBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> thenByYearPublished() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'yearPublished', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByYearPublishedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'yearPublished', Sort.desc);
    });
  }
...
extension BookQueryWhereDistinct on QueryBuilder<Book, Book, QDistinct> {
  ...
  QueryBuilder<Book, Book, QDistinct> distinctByYearPublished() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQueryProperty on QueryBuilder<Book, Book, QQueryProperty> {
  ...
  QueryBuilder<Book, int, QQueryOperations> yearPublishedProperty() {
    return QueryBuilder.apply(this, (query) {
